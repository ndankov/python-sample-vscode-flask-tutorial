[![Build Status](https://dev.azure.com/ndankov/TestProject/_apis/build/status/ndankov.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/ndankov/TestProject/_build/latest?definitionId=5&branchName=master)
